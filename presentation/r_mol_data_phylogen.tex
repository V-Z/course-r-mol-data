...
\begin{itemize}
 \item Download the presentation from \url{https://trapa.cz/sites/default/rcourse/r_mol_data_phylogen.pdf}
 ...
 \begin{itemize}
  ...
  \item \alert{Downloaded file must have sufix \texttt{*.r}, not \texttt{*txt}}
 \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
 ...
 \item When closing R by \texttt{q()} you can save all R data in \texttt{.RData} (and command history in \underline{.Rhistory}) file(s) and it/they can be loaded next time
...
\begin{frame}{Notes about paths to import the data}
\begin{itemize}
 ...
 \item One of the most common source of errors -- when the command fails, double check paths (and Internet connection, if applicable)
\end{itemize}
\end{frame}
