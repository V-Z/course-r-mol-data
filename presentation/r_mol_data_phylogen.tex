...
\begin{frame}{Overview of descriptive statistics} %TODO list of methods
  \begin{itemize}
    \item 
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Departure from Hardy-Weinberg equilibrium}
  \begin{itemize} % TODO  richer description
...
\begin{frame}[fragile]{Departure from HWE -- results per locus}
  ...
  \begin{tabular}{lllll}
    ...
    ... & ... & ... & ... & ...
  \end{tabular}
  \begin{itemize} %TODO details about tests
...
\begin{frame}[fragile]{Different distances have different use case and outputs\ldots}
  \begin{tabular}{llll} % TODO links to methods references
...
\begin{frame}[fragile]{Distances and genlight object} % FIXME
...
\begin{frame}[fragile]{For and while loops} % TODO one more example
  \begin{spluscode}
