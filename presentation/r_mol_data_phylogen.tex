...
\begin{frame}[fragile]{More options for Google map} % FIXME finish GMap
\begin{multicols}{2}
  \begin{spluscode}
  ...
  \end{spluscode}
  \begin{center}
    \includegraphics[height=6.5cm]{gmap.png}
  \end{center}
\end{multicols}
\end{frame}
...
\begin{frame}[fragile]{Plotting on SHP files II} % FIXME finish (adding extra content)
  \begin{spluscode}
...
\begin{frame}[fragile]{Plotting on SHP files III} % FIXME finish (adding extra content)
  \vfil
  \begin{spluscode}
    # Add legend
