...
\begin{itemize}
 ...
 \item \texttt{outpath} should aim to empty directory
...
\begin{itemize}
 ...
 \item \texttt{parallel\_structure()} is missing paralleling library which is not available on Windows, instead try
\end{itemize}
  \begin{spluscode}
...
\begin{multicols}{2}
  ...
  \splus/# Parsimony details: ?parsimony/
  \begin{spluscode}
...
\begin{flushright}
  ...
  \vfill
  \begin{tiny}
   \href{https://en.wikipedia.org/wiki/XeTeX}{Typesetting} using \XeLaTeX~on \href{https://www.opensuse.org/}{openSUSE} \href{https://en.wikipedia.org/wiki/GNU}{GNU}/\href{https://en.wikipedia.org/wiki/Linux}{Linux}
  \end{tiny}
\end{flushright}
\end{frame}
